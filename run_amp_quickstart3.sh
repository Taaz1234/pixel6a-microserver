...
chroot $ROOTFS /bin/su amp -c "export PATH=/usr/local/bin:/opt/cubecoders/amp:$PATH; export HOME=/home/amp; cd /home/amp; ampinstmgr QuickStart admin Paco3421 0.0.0.0 8085"
